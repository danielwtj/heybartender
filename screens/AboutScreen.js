...
export default function AboutScreen(props) {
    return (
        <ScrollView style={[styles.container, {paddingHorizontal: 15}]}>
            <Text style={material.display1}>Spiritual</Text>
            ...
            <Text style={material.body1}>"Spiritual" in its present form does not collect any personally identifiable information about its users. All recipes are stored on your device and no log in is required to use the app. We will update this Privacy Policy in the case that any future features require the collection of your data.</Text>
            <Text style={material.body2}>Third-party Software</Text>
            <Text style={material.body1}>"Spiritual" is built with Expo SDK, which gives the ability to offer minor updates over-the-air.</Text>
